...
error["low"] = fuzz.trimf(error.universe, [-60, -40, 5])
error["zero"] = fuzz.trimf(error.universe, [-10, 0, 10])
error["high"] = fuzz.trimf(error.universe, [5, 40, 60])
error["veryhigh"] = fuzz.trimf(error.universe, [50, 100, 100])

valve = ctrl.Consequent(universe_valve, "valve")
valve["off"] = fuzz.trimf(valve.universe, [0, 0, 1.1])
valve["slow"] = fuzz.trimf(valve.universe, [1, 1.5, 2.5])
valve["medium"] = fuzz.trimf(valve.universe, [3, 5, 6])
valve["medfast"] = fuzz.trimf(valve.universe, [5, 6, 8])
valve["fast"] = fuzz.trimf(valve.universe, [7, 10, 10])
error.view()
valve.view()
...
rule2 = ctrl.Rule(error["low"], valve["medfast"])
rule3 = ctrl.Rule(error["zero"], valve["medium"])
