...
error["low"] = fuzz.trimf(error.universe, [-60, -30, -20])
error["littlelow"] = fuzz.trimf(error.universe, [-25, -10, 0])
...
valve["slow"] = fuzz.trimf(valve.universe, [0, 1, 3.5])
valve["medium"] = fuzz.trimf(valve.universe, [2, 4, 6])
valve["fast"] = fuzz.trimf(valve.universe, [5, 10, 10])
error.view()
valve.view()
